        ...
        <Container>
          <Row className="mb-3">
            <Col xs={6} md={6} lg={3} className="contact-column">
              <Card.Text className="contact-items">
                <img src={t('contacts.phone_label')} alt="Phone" /> {t('contacts.phone')}
              </Card.Text>
              <Card.Text style={{ fontWeight: 'bold' }}>+7 (707) 682-56-76</Card.Text>
            </Col>
            <Col xs={6} md={6} lg={2} className="contact-column">
              <Card.Text className="contact-items">
                <img src={t('contacts.email_label')} alt="Email" /> {t('contacts.email')}
              </Card.Text>
              <Card.Text style={{ fontWeight: 'bold' }}>info@eosi.kz</Card.Text>
            </Col>
            <Col xs={8} md={6} lg={5} className="contact-column">
              <Card.Text className="contact-items">
                <img src={t('contacts.address_label')} alt="Address" /> {t('contacts.address')}
              </Card.Text>
              <Card.Text style={{ fontWeight: 'bold' }}>{t('contacts.exactAddress')}</Card.Text>
            </Col>
            <Col xs={4} md={6} lg={2} className="d-flex justify-content-end">
